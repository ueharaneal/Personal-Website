  ...
  return (
    <section className="px-6 text-white">
      <div className="w-full max-w-5xl mx-auto grid gap-8 grid-cols-1 lg:grid-cols-[1fr_350px]">
        <div>
          <p className="text-4xl font-semibold mb-8 font-sans"> MY <span className="text-[#7B68EE]">PROJECTS</span></p>
    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="-ml-8 -mr-6 -mb-7 mt-4 py-2 rounded-b-2xl flex items-center justify-center gap-1 group transition-[gap] bg-gradient-to-r from-indigo-600 to-indigo-900"
        >
