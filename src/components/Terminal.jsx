  ...
  return (
    ...
    >
      <div
        ...
        className="h-96 bg-indigo-950/70 backdrop-blur rounded-lg w-full max-w-3xl mx-auto overflow-y-scroll shadow-xl cursor-text font-mono"
      >
        <TerminalHeader />
...
const TerminalHeader = () => {
  return (
    <div className="w-full p-3 bg-gray-700 flex items-center gap-1 sticky top-0 ">
      <div className="w-3 h-3 rounded-full bg-red-500" />
      <div className="w-3 h-3 rounded-full bg-yellow-500" />
      <div className="w-3 h-3 rounded-full bg-green-500" />
      <div className="h-6 w-6 absolute left-[40%]"><Terminal className="h-full w-full"/></div>
...
const InitialText = () => {
  return (
    <>
      <div>Hi there! Like what you saw?</div>
      <p className="whitespace-nowrap overflow-hidden font-light">
        ------------------------------------------------------------------------
      </p>
      <p> Please fill as prompted on screen!</p>
      <p className="whitespace-nowrap overflow-hidden font-light">
        ------------------------------------------------------------------------
      </p>
    </>
