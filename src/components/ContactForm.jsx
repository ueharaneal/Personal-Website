...
function ContactForm() {
  ...
  return (
    <div className="flex text-[#EBE4D1] mb-16">
      <div className="flex flex-row items-end">
        ...
        >
          <p className=" whitespace-nowrap font-heavy text-3xl">
            Send me a{" "}
            <span className="text-4xl font-bold py-1 border-b-4 border-[#7B68EE]">
              message
            </span>{" "}
            !
          </p>
        ...
        <div className="flex flex-col justify-center h-[70%] w-[40%] px-16 -ml-32 -mb-4 p-8 z-40 text-black rounded-md bg-[#e1d5b7] border-8 border-[#7B68EE]">
          ...
          <p className="text-[#2e2370] text-center text-lg md:text-xl z-40 -mb-3">
            Have an idea?
          </p>
          ...
          <p className="text-[#2e2370] text-center text-lg -mt-2">
            Lets build something amazing!
          </p>
          <div className="flex flex-row">
            <MdEmail size={12} className="z-60"/>
            <div className="p-5 z- 20 bg-gradient-to-r from-[#E97451]  to-transparent backdrop-blur-sm rounded-xl">
