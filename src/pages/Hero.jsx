...
const Hero = ({ setSelectedPage }) => {
  ...
  return (
    <section id="home" className="text-[#EBE4D1] relative">
      <div className="relative flex flex-col h-screen w-full justify-center text-center mx-auto max-w-[800px]  p-3 z-20">
