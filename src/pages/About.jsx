			...
			<div className=' text-[#EBE4D1]'>
				...
				<div className='flex flex-col'>
					...
					<div className='flex flex-col items-center md:flex-row mb-24'>
						...
						>
							Hey there! I'm all about the adrenaline rush – whether it's
							from a sticking a drop surfing, shredding a snowboard
							through a blizzard, or solving a challenging bug in my
							code. When I'm not out chasing that next big thrill, you
							can find me lost in a good book, taking amazing photos or
							exploring the latest news in tech, always on the hunt to
							learn something new. Keep scrolling to learn about me!
						</motion.p>
						...
						<div className='flex flex-col'>
							<div className='flex flex-col px-2'>
								<div className='flex flex-row justify-center md:justify-end'>
									...
									>
										My{" "}
										<span className='text-[#7B68EE]'>Timeline</span>
									</motion.div>
								</div>
							...
							<div className='flex flex-col mt-24'>
								...
								>
									<p className='flex justify-between'>
										...
										<span className='mt-5 text-xs md:text-lg whitespace-nowrap text-gray-400'>
											July 2023
										</span>{" "}
									</p>
									<p className='flex justify-between'>
										CompTIA A+{" "}
										<span className='mt-5  text-xs md:text-lg text-gray-400'>
											July 2023
										</span>
									</p>
									<p className='mt-3'>
