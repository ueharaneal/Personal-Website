		...
		>
			<div className='flex flex-col justify-center '>
				<motion.h1
					...
					className='font-bold font-sans text-3xl md:text-4xl  mt-4  ml-6 xl:ml-24  p-7 bg-gradient-to-r from-black/20  to-transparent backdrop-blur-sm rounded-xl w-fit'
				>
